...
def plot_roc_curve(fpr_list, tpr_list, file_path):
    ...
    plt.xlabel('False Positive Rate')
    plt.ylabel('True Positive Rate')
    plt.title(u"piston shoes (ROC)")
    plt.savefig(os.path.join(file_path, 'ROC_Curve_piston_shoes.jpg'))
    ...
    plt.xlabel('False Positive Rate')
    plt.ylabel('True Positive Rate')
    plt.title(u"valve plate (ROC)")
    plt.savefig(os.path.join(file_path, 'ROC_Curve_valve_plate.jpg'))
...
def plot_pr_curve(precision_list, recall_list, file_path):
    ...
    plt.xlabel('False Positive Rate')
    plt.ylabel('True Positive Rate')
    plt.title(u"piston shoes (PR)")
    plt.savefig(os.path.join(file_path, 'PR_Curve_pistun_shoes.jpg'))
    ...
    plt.xlabel('False Positive Rate')
    plt.ylabel('True Positive Rate')
    plt.title(u"valve plate(PR)")
    plt.savefig(os.path.join(file_path, 'PR_Curve_valve_plate.jpg'))